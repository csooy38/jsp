...
public class BoardDTO {
	...
	private int board_c_count;
	
	
	public int getBoard_c_count() {
		return board_c_count;
	}
	public void setBoard_c_count(int board_c_count) {
		this.board_c_count = board_c_count;
	}
