...
<body>
	...
	<%-- 
		...
		2. <%@ include %> : 현재 페이지에 다른 문서(JSP, HTML)를
			가져와서 내용을 컴파일 할 때 사용되는 디렉티브.
			형식) <%@ include file="포함할 파일의 url" %>
			- include 지시어를 사용한 JSP 페이지가 컴파일되는 과정에서
	 ...
	 <%-- 
	  ...
	  <%-- 스클립틀릿 : 자바 코드가 작성되는 공간 --%>
	  
	  <!-- Servlet은 서블릿에 자바 코드, JSP는 HTML 안에 자바 코드  작성 가능.-->
