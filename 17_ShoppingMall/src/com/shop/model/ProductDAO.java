...
public class ProductDAO {
	...
	public List<ProductDTO> getProductList() {
		...
		try {
			...
			while (rs.next()) {
				...
				dto.setPimage(rs.getNString("pimage"));
	...
	public ProductDTO productCont(int pnum) {
		ProductDTO dto = new ProductDTO();
	...
	public int updateProdect(ProductDTO dto) {
		int result = 0;

		try {
			openConn();
			sql = "update shop_products set pcompany=?, pimage=?, pqty=?, price=?, pspec=?, pcontents=?, point=?, pinputdate=sysdate where pnum = ?";
	...
	public List<ProductDTO> getProductLists(String p_code) {
		List<ProductDTO> list = new ArrayList<ProductDTO>();
