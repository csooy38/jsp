...
<body>
	...
	<div align="center">
		...
		<table border="1" cellspacing="0" width="65%">
			<tr bgcolor="#ffcc00">
				<th>상품 번호</th> <th>카테고리 코드</th> <th>상 품 명</th> <th>이 미 지</th>
				<th>상품 가격</th> <th>수 량</th> <th>제 조 사</th> <th>상품 입고일</th> <th>수 정 | 삭 제</th>
			</tr>
			...
			<c:if test="${!empty list }">
				<c:forEach items="${list }" var="dto">
					<tr>
						...
						<td>${dto.getPname() }</td>
						<td><img src="<%=imgPath %>${dto.getPimage() }" width="60" height="60"></td>
