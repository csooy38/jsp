...
<body>
	...
	<div align="center">
		...
		<form method="post" action="<%=request.getContextPath()%>/admin_prod_input_ok.do" enctype="multipart/form-data">
			<table border="1" cellspacing="0" width="350">
				...
				<tr>	
					...
					<td>
						<select name="p_spec">
							<option value="none" seleced>일반</option>
							<option value="hit" seleced>인기</option>
							<option value="new" seleced>최신</option>
							<option value="recommand" seleced>추천</option>
						</select>
					</td>
				</tr>
				...
				<tr>	
					<th>상품 소개</th>
					<td><textarea rows="7" cols="30" name="p_content"></textarea></td>
				</tr>
